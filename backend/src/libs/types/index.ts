...
export type APIGatewayProxyRequest<S = unknown, P = APIGatewayProxyEventPathParameters, Q = APIGatewayProxyEventQueryStringParameters> = Omit<APIGatewayProxyEvent, 'body' | 'pathParameters' | 'queryStringParameters'> & { body: S, pathParameters: P, queryStringParameters: Q | null}
